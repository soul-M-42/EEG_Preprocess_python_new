...
for sub in tqdm(range(61), desc=f'Reading sub:'):
    raws_sub = []
    valid_trials_sub = []
    ...
    for trial_id in range(50):
        ...
        try:
            ...
            try:
                ...
                print(f'ERROR Read Sub {sub+1} Trial {trial_id}')
                # raws_sub.append(None)
                continue
        except:
            print(f'Sub {sub} has no trial {trial_id}')
            continue
        ...
        try:
            ...
            trial_i_downsampled = raw_selected
