...
def reorder_eeg_trials(root_dir, subject_num, trial_type='imagery'):
    ...
    sub_sequence = get_reordered_sequence(subject_num)
    ...
    try:
        ...
        if trial_type == 'imagery':
            target_sequence = ['ten8', 'ten5', 'ten4', 'fear8', 'fear5', 'fear4', 
                    'dis8', 'dis5', 'dis4', 'joy8', 'joy5', 'joy4', 
                    'sad8', 'sad5', 'sad4', 'neu8', 'neu5', 'neu4', 
                    'ins8', 'ins5', 'ins4']
        else:  # video
            target_sequence = ['joy8', 'joy5', 'joy4', 'sad8', 'sad5', 'sad4', 
                    'dis8', 'dis5', 'dis4', 'ins8', 'ins5', 'ins4', 
                    'fear8', 'fear5', 'fear4', 'neu8', 'neu5', 'neu4', 
                    'ten8', 'ten5', 'ten4']
    ...
    for new_idx, trial_name in enumerate(target_sequence, start=1):
        ...
        original_idx = sub_sequence.index(trial_name) + 1  # +1 because trials start at 1
        
        # original_num, original_fname = trial_files[original_idx - 1]
        original_fname = f'sub-{subject_num:02d}_ses-{trial_type}_task-emotion_{trial_name}.npy'
        ...
        print(f"Saved {output_fname} (originally trial {original_fname}")
